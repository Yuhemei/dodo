<template>
  <div>
    <postDetailHead :post="post"></postDetailHead>
    ...
    <div class="mainContent">
      ...
      <div class="commentList">
        ...
        <comment v-else v-for="(item,index) in comments" :key="index" :commentItem="item"></comment>
    ...
    <postDetailFooter :post="post" @newComment="getComments" @starChanged="starChanged"></postDetailFooter>
  </div>
</template>
